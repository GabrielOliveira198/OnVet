        ...
        <div class="card">
            <div class="card-header">
                ...
                <div style="float: right;">
                    <a href="{{ url('cadastros/iatfs/create/0') }}" class="btn btn-outline-primary waves-effect">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <a href="{{ url('cadastros/iatfs/create') }}/{{ $iatf->id ?? null }}"
                                ...
                                <a  href="javascript:void(0);" class="btn btn-icon btn-outline-warning waves-effect" 
                                   ...
                                   onclick="deleteItem('{{ url('cadastros/iatfs/delete') }}/{{ $iatf->id ?? null }}');"
                                >
